...
class Board:
    def __init__(self):
        self.board_size = [[[0 for x in range(10)] for y in range(20)] for z in range(10)]
                ...
                for x in range(10):
                    if self.board_size[x][y][z] != 0:
                        pygame.draw.rect(screen, COLOR_ARRAY[abs(self.board_size[x][y][z]) - 1],
                                         (400 + x * 20, 200 + y * 20, 20, 20))
                        pygame.draw.rect(screen, (255, 255, 255),
                                         (400 + x * 20, 200 + y * 20, 20, 20), width=1)
        ...
        for z in range(10):
            for y in range(19, -1, -1):
                for x in range(10):
                    if self.board_size[x][y][z] != 0:
                        pygame.draw.rect(screen, COLOR_ARRAY[abs(self.board_size[x][y][z]) - 1],
                                         (800 + (9 - z) * 20, 200 + y * 20, 20, 20))
                        pygame.draw.rect(screen, (255, 255, 255),
                                         (800 + (9 - z) * 20, 200 + y * 20, 20, 20), width=1)
        ...
        for y in range(19, -1, -1):
            for z in range(10):
                for x in range(10):
                    ...
                    if y == 19 or self.board_size[x][y + 1][z] != 0:
